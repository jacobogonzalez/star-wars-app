...
<template>
  <div class="d-flex flex-column h-100 pa-4">
    ...
    <component v-if="!error" :is="viewMode === 'table' ? DataTable : DataList" :items="paginatedItems"
      :headers="headers" :loading="loading" :search="search" :sort-by="sortKey" :sort-desc="!sortAsc"
